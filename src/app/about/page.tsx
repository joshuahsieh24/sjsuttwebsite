...
export default function About() {
  return (
    <>
      ...
      <section className="min-h-[120px] flex items-center bg-[#141416] text-white py-10">
      ...
      <section className="min-h-[300px] flex items-center bg-[#18181a] text-white py-10">
        <div className="max-w-[1100px] mx-auto px-4 w-full">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8 pt-8">
            <div className="flex-1 max-w-[50%] text-left">
              <div className="grid grid-rows-[40px_auto]">
                <h2 className="text-[#fecb33] font-semibold mb-2">WHO ARE WE?</h2>
      ...
      <section className="py-16 bg-[#141416]">
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-col gap-8">
            <h1 className="text-[#fecb33] font-semibold text-xl mb-4">Our Values</h1>
    ...
    <section className="py-16 bg-[#18181a]">
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-col gap-8">
            <h1 className="text-[#fecb33] font-semibold text-xl mb-4">I. Brotherhood</h1>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
    ...
    <section className="py-16 bg-[#141416]">
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-col gap-8">
            <h1 className="text-[#fecb33] font-semibold text-xl mb-4">II. Professionalism</h1>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-col gap-8">
            <h1 className="text-[#fecb33] font-semibold text-xl mb-4">III. Community Service</h1>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
